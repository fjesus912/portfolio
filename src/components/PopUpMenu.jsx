const PopUpMenu = () => {
  ...
  return (
      ...
      <nav className={`fixed z-30 py-2 bottom-6 left-1/2 -translate-x-1/2 bg-slate-800/25 backdrop-blur-lg flex rounded-full justify-start font-semibold border sm:-right-full sm:hidden transition-all`}>
